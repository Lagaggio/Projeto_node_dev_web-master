...
module.exports = app => {
    ...
    controller.createTarefa = function (req, res, next) {
        ...
        const data_inicio = req.body.data_inicio.lenght ? req.body.data_inicio : "06/29/2021 00:00:00";
        const data_fim = req.body.data_fim.lenght ? req.body.data_fim : "06/29/2021 00:00:00";
        ...
        const data_inicio_dev = req.body.data_inicio_dev.lenght ? req.body.data_inicio_dev : "06/29/2021 00:00:00";
        const data_fim_dev = req.body.data_fim_dev.lenght ? req.body.data_fim_dev : "06/29/2021 00:00:00";
    ...
    controller.putTarefa = function (req, res, next) {
        let {id, titulo, descricao, id_projeto, id_criador, id_dev, tempo_estimado, 
             ...
             complexidade, impacto, id_grupo} = req.body;
